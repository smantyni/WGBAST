...
for (y in 1:27){
for (d in 1:31){
mu_CPUE[y,d]<- (mu_Catch[y,d]*400)/(mu_Soak[y,d] * 26 * mu_Effort[y,d]* 850)
...
eta_S~dunif(2,100)
eta_E~dunif(2,100)
eta_Catch~dunif(2,100)
eta_Soak~dunif(2,100)
eta_Effort~dunif(2,100)
...
dat<-read_xlsx("01-submodels/Aland/CPUEdata07.xlsx", range="A2:E7472", 
