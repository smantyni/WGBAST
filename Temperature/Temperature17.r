...
dat2<-mutate(dat2,Month=month(as.POSIXct(dat2$Date)))
dat2<-mutate(dat2,Day=day(as.POSIXct(dat2$Date)))

dat2<-filter(dat2, Month<5)

dat2<-mutate(dat2, year=Year-1991)
