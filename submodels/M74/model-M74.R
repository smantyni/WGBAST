...
for (y in 1:31){ # Years , last spawning yearclass in the data is 30=2014
...
for (s in 1:13){  # Obs! Kemijoki added
...
for (i in 1:310){ # number of rows in the Swedish data 
...
data<-list(
  ...
  j=M74,
  k=mortality100,
  n=length(df$eggs), # number of females/rows
# SE data:
    )
